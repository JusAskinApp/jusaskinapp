...
function MeetingForm(groupid) {
    ...
    const handleSave = (event) => {
        ...
        if (
            ...
            formState.startdate &&
            formState.enddate && formState.zoomLink
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px', margin: "10px" }}>
            <h1 style={{ fontSize: "40px" }}>   Schedule Meeting </h1>
            <form>
                    ...
                    <Grid item xs={6}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DemoContainer components={['DateTimePicker']}>
                                <DateTimePicker label="Start date and time" onChange={(newDate) => { onDateChange('startdate', newDate) }} />
                            </DemoContainer>
                        </LocalizationProvider></Grid>
                    <Grid item xs={6}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <DemoContainer components={['DateTimePicker']}>
                                <DateTimePicker label="End date and time" onChange={(newDate) => { onDateChange('enddate', newDate) }} />
                            </DemoContainer>
                        </LocalizationProvider>                    </Grid>
                    <Grid item xs={12}>
                        <TextField
