...
function Features() {
  return (
    <div>
      <h1 className="text-4xl font-bold text-center mt-20">Our App Features</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 mx-auto md:justify-center md:p-16">
